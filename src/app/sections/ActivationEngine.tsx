...
const activations = [
  ...
  },
  {
    ...
    desc: "Halloween. Christmas. Back to School. Your brand owns the cultural moment — inside the place where people already gather.",
  },
];
  ...
  return (
    <section id="activation" className="relative section-cinematic">
      ...
      <div ref={ref} className="section-cinematic-inner relative z-[2]">
        ...
        >
          Your activation isn't a pop-up tent in a parking lot. It's inside a permanent, trusted, daily-trafficked space.
          People eat here every day. Your brand becomes part of their habit. <span className="text-lime font-semibold">Not an event. An environment.</span>
        </motion.p>
          ...
          {activations.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="card-dark p-8 rounded-xl group hover:border-lime/20"
              >
                <div className="flex items-start gap-5">
                  <div className="w-11 h-11 rounded-lg bg-lime/10 flex items-center justify-center shrink-0 group-hover:bg-lime/20 transition">
        ...
        <motion.div
          ...
          className="card-glass rounded-2xl p-8 md:p-12 border-glow-lime text-center"
        >
          <h3 className="text-2xl md:text-3xl font-bold text-text-primary mb-4">
            Your Brand Is The Vibe.
          </h3>
          <p className="text-text-secondary max-w-xl mx-auto mb-8 text-sm">
            Not an ad on the wall. Not a sticker on a window. Your brand IS the store. The music.
            The menu font. The cup design. The wall art. The QR code that leads deeper.
            A total sensory ecosystem — flipped overnight.
          </p>
