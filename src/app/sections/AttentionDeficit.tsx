    ...
    <section id="attention-deficit" className="relative section-cinematic">
      ...
      <div ref={ref} className="section-cinematic-inner relative z-[2]">
        <motion.p
          ...
          className="eyebrow-cyan mb-6 text-cyan"
        >
        ...
        >
          They grew up with YouTube, not TV. With Discord, not radio. With Twitch drops, not magazine ads.
          ...
          {stats.map((stat, i) => {
            ...
            return (
              <motion.div
                ...
                className="card-dark p-6 rounded-xl group hover:border-cyan/20"
              >
                <Icon size={20} className="text-cyan mb-4" />
                <div className="stat-number gradient-cyan-text mb-2">{stat.value}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-text-secondary text-sm leading-relaxed">
              They watch tournaments for 6+ hours straight — but skip every ad. They follow their favourite streamers religiously — but will never click a sponsored link. 
              Their loyalty is tribal, not transactional. <span className="text-cyan">To reach them, you must become part of the environment they trust.</span>
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-text-secondary text-sm leading-relaxed">
              They're the ones building the next unicorn on a laptop in a shared workspace. They're designing brands, coding apps, starting agencies.
              They need tools, not ads. They need partners, not sponsors. <span className="text-lime">When they walk into your branded world, they're not being pitched — they're being invited.</span>
            </p>
          </motion.div>
        </div>
      </div>
